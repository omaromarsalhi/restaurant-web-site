                                        ...
                                        <?php
                                           ...
                                           ?>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <input class="btn btn-primary" type="submit" value="Delete user" name='deleteUserFromDb'>
                                                </td>
                                            </tr>
                                        <?php }?>
                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div>
                                                            <img src="../../assets_Admin/img/small-logos/logo-asana.svg" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                                                        </div>
                                                        <div class="my-auto">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div>
                                                            <img src="../../assets_Admin/img/small-logos/github.svg" class="avatar avatar-sm rounded-circle me-2" alt="invision">
                                                        </div>
                                                        <div class="my-auto">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div>
                                                            <img src="../../assets_Admin/img/small-logos/logo-atlassian.svg" class="avatar avatar-sm rounded-circle me-2" alt="jira">
                                                        </div>
                                                        <div class="my-auto">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div>
                                                            <img src="../../assets_Admin/img/small-logos/bootstrap.svg" class="avatar avatar-sm rounded-circle me-2" alt="webdev">
                                                        </div>
                                                        <div class="my-auto">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div>
                                                            <img src="../../assets_Admin/img/small-logos/devto.svg" class="avatar avatar-sm rounded-circle me-2" alt="xd">
                                                        </div>
                                                        <div class="my-auto">
